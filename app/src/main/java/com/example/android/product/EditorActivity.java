...
public class EditorActivity extends AppCompatActivity implements
    ...
    /**
     * Button ADD PRODUCT to increasing amount of product in the warehouse
     */
    private Button mAddProductButton;

    /**
     * Button DELETE PRODUCT to decreasing amount of product in the warehouse
     */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mCurrentProductUri == null) {
            ...
            mPhoto.setImageResource(R.drawable.empty_store);
